        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.lect.index')" :active="request()->routeIs('admin.lect.index')">
                        {{ __('Lecturer') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.student.index')" :active="request()->routeIs('admin.student.index')">
                        {{ __('Student') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.class.index')" :active="request()->routeIs('admin.class.index')">
                        {{ __('Class') }}
                    </x-nav-link>
                </div>
            </div>
